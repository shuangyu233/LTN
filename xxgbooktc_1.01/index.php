...
?>      
  ...
  ?>
   ...
   <!-- </div>-->  
<footer class="p-5 text-center">Powered by <a href="https://7alk.com/" target="_blank">7alk</a> Talk <?php echo $config['ver'];?>  <?php echo $config['title'];?> Processed <?php $t2 = microtime(true); echo round($t2-$t1,3); ?>s</footer>   
<!--对话框-->
<!-- 模态框 -->
